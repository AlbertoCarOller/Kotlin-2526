...
class WordsRepository(
    ...
    override suspend fun insertWordList(wordList: List<WordModel>) = wordsDAO.insertWordList(wordList)
    ...
    override suspend fun getOnceSomeRandomWordsByLanguage(language: String, number: Int) : List<WordModel> = wordsDAO.getOnceSomeRandomWordsByLanguage(language, number)
