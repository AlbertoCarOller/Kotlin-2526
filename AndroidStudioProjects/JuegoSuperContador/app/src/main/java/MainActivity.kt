...
class MainActivity : ComponentActivity() {
    ...
    fun PrincipalStructure(modifier: Modifier) {
        /* Declaramos las variables con 'by rememberSaveable { mutableIntStateOf(valor_inicial) }' para que no se
         ...
         el estado de la variable, SOLO SABE GUARDAR TIPOS BÁSICOS: Int, String, Boolean, etc. EN CAMBIO
          EL remember {} (el que solo recuerda, pero no guarda en mochila) puede guardar cualquier
          tipo de objeto */
